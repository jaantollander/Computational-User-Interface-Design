...
Normalization can be implemented as shown by [@Mausser2006]
...
TODO: Plot the values of \(f_1\) and \(f_2\) as a function of the weights \(u_i\).

- TODO: track independent values of \(f_1\) and \(f_2\)
- List 4 pareto optimal designs
